...
pub const TEXT: ThemeColor = ThemeColor::new(0xCAC2B6, 1.0);
pub const TEXT_HOVERED: ThemeColor = ThemeColor::new(0xE1E0DD, 1.0);
pub const TEXT_DARKER: ThemeColor = ThemeColor::new(0x848484, 1.0);
