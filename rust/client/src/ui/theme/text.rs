...
impl text::Catalog for GauntletComplexTheme {
    ...
    fn style(&self, class: &Self::Class<'_>) -> Style {
        match class {
            ...
            TextStyle::ActionSectionTitle => {
                Style {
                    color: Some(self.action_section_title.text_color),
                }
            }
            TextStyle::EmptyViewSubtitle => {
                Style {
            ...
            TextStyle::InlineSeparator => {
                Style {
                    color: Some(self.inline_separator.text_color),
                }
            }
            TextStyle::RootBottomPanelPrimaryActionText => {
                Style {
                    color: Some(self.root_bottom_panel_primary_action_text.text_color),
                }
            }
            TextStyle::RootBottomPanelActionToggleText => {
                Style {
