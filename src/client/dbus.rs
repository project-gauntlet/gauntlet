...
use crate::common::dbus::{DbusEventViewCreated, DbusEventViewEvent, DBusSearchResult, DBusUiPropertyContainer, DBusUiWidget};
use crate::common::model::PluginUuid;
use crate::utils::channel::RequestSender;

pub struct DbusClient {
    pub(crate) context_tx: RequestSender<(PluginUuid, NativeUiRequestData), NativeUiResponseData>
}
...
impl DbusClient {
    ...
    async fn get_container(&mut self, plugin_uuid: &str) -> DBusUiWidget {
        let input = (PluginUuid::new(plugin_uuid), NativeUiRequestData::GetContainer);
    ...
    async fn create_instance(&mut self, plugin_uuid: &str, widget_type: &str, properties: DBusUiPropertyContainer) -> DBusUiWidget {
        ...
        let input = (PluginUuid::new(plugin_uuid), data);
    ...
    fn append_child(&mut self, plugin_uuid: &str, parent: DBusUiWidget, child: DBusUiWidget) {
        ...
        self.context_tx.send((PluginUuid::new(plugin_uuid), data)).unwrap();
    }
